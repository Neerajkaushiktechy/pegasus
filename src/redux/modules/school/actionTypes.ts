...
export const CHECK__USERID_REQUEST = "CHECK__USERID_REQUEST";
export const CHECK__USERID_FALIURE = "CHECK__USERID_FALIURE";
export const CHECK_USERID_SUCCESS = "CHECK_USERID_SUCCESS";