...
export const RESET_MYASSIGNMENTSTATUS_REQUEST = "RESET_MYASSIGNMENTSTATUS_REQUEST";
export const RESET_MYASSIGNMENTSTATUS_SUCCESS = "RESET_MYASSIGNMENTSTATUS_SUCCESS";
export const RESET_MYASSIGNMENTSTATUS_FALIURE = "RESET_MYASSIGNMENTSTATUS_FALIURE";


export const RESET_MYASSIGNMENTDATA_REQUEST = "RESET_MYASSIGNMENTDATA_REQUEST";
export const RESET_MYASSIGNMENTDATA_SUCCESS = "RESET_MYASSIGNMENTDATA_SUCCESS";
export const RESET_MYASSIGNMENTDATA_FALIURE = "RESET_MYASSIGNMENTDATA_FALIURE";


export const RESET_ASSIGNMENT_REQUEST = "RESET_ASSIGNMENT_REQUEST";
export const RESET_ASSIGNMENT_SUCCESS = "RESET_ASSIGNMENT_SUCCESS";
export const RESET_ASSIGNMENT_FALIURE = "RESET_ASSIGNMENT_FALIURE";
